import type { ReservationBody } from '$/packages/application/usecase/admin/reservations/validators';
import type { CreateReservationData, UpdateReservationData } from '$/packages/domain/database/reservation';
